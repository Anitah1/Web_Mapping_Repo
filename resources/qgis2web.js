...
map.getView().fit([42.550146, -0.351667, 42.603846, -0.314001], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Dalxiska Women Market Beneficiaries Registration Guidance Map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (366 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is an interactive map to help with the registration of beneficiaries of the constructed women\'s market in Dalxiska IDP site section in KIsmayo. The map shows the location of the constructed women\'s market as a polygon and the IDP sites within the Dalxiska IDP section. This map will provide guidance for registration within a 2km buffer from the women\'s market.';
            }
